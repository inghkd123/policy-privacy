...
|---|---|---|---|---|
|이엘일렉트릭|㈜파킹스루|멤버십카드 발급, 발송|회원가입정보, 배송 주소|서비스 해지 시 까지|

* 단 법령에서 따로 정하는 경우에는 해당 기간까지 보유합니다.

* 회사는 상기 정보와 목적 외에는 이용자의 정보를 제공하지 않으며, 서비스 이용을 위한 목적 외에는 고객정보를 활용하지 않습니다.

* 상기 내용이 변경되는 경우 서비스 홈페이지(wev-charger.com)를 통해 안내 드립니다.
